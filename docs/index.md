...
<div class="caja-feature-section">
  <div class="caja-feature-content">
    <div class="caja-feature-text">
      <h2>Robust Encapsulation</h2>
      <p>Safely control module boundaries using the <code>private</code> access modifier on variables and types, preventing unintended external side effects.</p>
    </div>
  </div>
</div>
...
<div class="caja-feature-section">
  <div class="caja-feature-content">
    <div class="caja-feature-text">
      ...
      <p>Easily encode scripts and their dependencies into a single, highly transportable base64-like token string for effortless distribution.</p>
    </div>
  </div>
</div>
